...
public class AdminAuthFilter implements Filter {
	...
	throws IOException, ServletException
    {
        ...
        {
            throw new ServletException(new Exception("คุณไม่มีสิทธิ์ในการเข้าถึง"));
        }
	...
	if (filterConfig == null) return ("AdminAuthFilter()");
	...
	public void setParameter(String name, String []values) {
	    if (debug) System.out.println("AdminAuthFilter::setParameter(" + name + "=" + values + ")" + " localParams = "+ localParams);
	...
	public String getParameter(String name) {
	    if (debug) System.out.println("AdminAuthFilter::getParameter(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public String[] getParameterValues(String name) {
	    if (debug) System.out.println("AdminAuthFilter::getParameterValues(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public Enumeration getParameterNames() {
	    if (debug) System.out.println("AdminAuthFilter::getParameterNames() localParams = " + localParams);
	    if (localParams == null)
	...
	public Map getParameterMap() {
	    if (debug) System.out.println("AdminAuthFilter::getParameterMap() localParams = " + localParams);
	    if (localParams == null)
