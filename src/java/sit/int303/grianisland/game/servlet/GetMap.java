...
public class GetMap extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getSession(false).getAttribute("player");
        int mapId=((Player)(request.getSession(true).getAttribute("player"))).getMap();
        MapManager maps=(MapManager) getServletContext().getAttribute("maps");
        request.setAttribute("map",maps.getMap(mapId));
        getServletContext().getRequestDispatcher("/Map.jsp").include(request, response);
    } 
